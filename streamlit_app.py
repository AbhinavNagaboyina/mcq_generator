    ...
    if button:
        with st.spinner("loading..."):
            try:
                ...
                st.sidebar(f"Total Tokens:{cb.total_tokens}")
                st.sidebar(f"Prompt Tokens:{cb.prompt_tokens}")
                st.sidebar(f"Completion Tokens:{cb.completion_tokens}")
                st.sidebar(f"Total Cost:{cb.total_cost}")
